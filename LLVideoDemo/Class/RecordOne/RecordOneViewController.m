...
#import "RecordOneViewController.h"
#import <AVKit/AVKit.h>
#import <AVFoundation/AVFoundation.h>

@interface RecordOneViewController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@end

@implementation RecordOneViewController
...
- (IBAction)record:(id)sender {
    ...
    ipc.videoMaximumDuration = 50;//30秒
